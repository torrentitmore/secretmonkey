...
function main (log, level = 0) {
    ...
    sites.push(new SiteClass('realpornclip.com', false, ['main-sidebar']) )
    sites.push(new SiteClass('anacams.com', false, ['modalewelcome']) )
    ...
    sites.push(new SiteClass('redgifs.com', false, ['legalLinks','OnlyFansCreatorsSidebar','cky-consent-bar','adSideBar','Button Button_tertiary Button_s aTab']) )
